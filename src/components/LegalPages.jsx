  ...
  <section className="legal-page" id="privacy">
    <div className="container legal-container">
      ...
      <div className="legal-body">
        ...
        <ul>
          <li>To respond to your enquiries and manage discovery call bookings</li>
          <li>To understand how our website is used and improve its content and performance</li>
          <li>To comply with legal and regulatory obligations applicable to our business</li>
          <li>To send relevant updates or capability information where you have consented</li>
        </ul>

        <h2>4. Legal Basis for Processing (GDPR)</h2>
        <p>Where the General Data Protection Regulation (EU) 2016/679 applies to our processing of your personal data, we rely on the following legal bases: (a) your consent, where given; (b) the performance of or entry into a contract with you; (c) our legitimate interests in operating and improving our business; and (d) compliance with a legal obligation.</p>

        <h2>5. Cookies</h2>
        <p>We use strictly necessary cookies to operate the site, and optional analytics cookies (e.g. Google Analytics) to understand usage patterns. You may accept, reject, or manage cookie preferences using the banner displayed on your first visit. Rejecting optional cookies will not affect your ability to use our website.</p>

        <h2>6. Data Sharing</h2>
        <p>We do not sell, rent, or trade your personal data. We may share data with trusted service providers (e.g. hosting, email, analytics platforms) who process data on our behalf under confidentiality obligations. Where required by law or a competent authority, we may disclose data to comply with legal obligations.</p>
  ...
  <section className="legal-page" id="terms">
    <div className="container legal-container">
      ...
      <div className="legal-body">
        ...
        <p>By accessing or using the Vahanti Technologies website (vahanti.in), you agree to be bound by these Terms of Service. If you do not agree, please discontinue use of the site immediately. These Terms govern your use of the website only; separate agreements govern any software development or service engagements.</p>
        ...
        <p>These Terms are governed by and construed in accordance with the laws of India. Any disputes arising from these Terms or your use of this website shall be subject to the exclusive jurisdiction of the courts of Bengaluru, Karnataka, India.</p>
